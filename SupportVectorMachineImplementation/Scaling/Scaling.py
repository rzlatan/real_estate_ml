...
with open(target_train_dataset, mode='w', newline='', encoding='utf8') as train_file:
    ...
    for row in train_dataset_before_scaling:
        ...
        satisfaction = float(row[headers["SATISFACTION"]])

        scaled_row = [location_scaled, square_footage_scaled, floor_scaled, room_count_scaled, year_built_scaled, satisfaction]
        print(scaled_row)
